...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="intro-section" id="home-section">
      ...
      <div class="slide-1" style="background-image: url('img19.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h1  data-aos="fade-up" data-aos-delay="100">Make Learning Awesome</h1>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
            <h2 class="section-title">Online Quiz Platform</h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('img18.jpg');">
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            
            <blockquote>
              <p>&ldquo; Engage your audience in a unique and fun way and connect them to your brand or learning material. By creating a returning event, you will improve your consumer loyalty.&rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4 ml-auto align-self-start"  data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
                ...
                <div><h3 class="m-0">Specially Made For Competitive Exams</h3></div>
              </div>
              ...
              <div class="d-flex align-items-center custom-icon-wrap custom-icon-light">
                <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-university"></span></span></div>
                <div><h3 class="m-0">Selected Practice Questions</h3></div>
              </div>
