...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="intro-section" id="home-section">
        ...
        <div class="slide-1" style="background-image: url('img21.jpg');" data-stellar-background-ratio="0.5">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-12">
                <div class="row align-items-center">
                  <div class="col-lg-6 mb-4">
                    <h1  data-aos="fade-up" data-aos-delay="100">Notification</h1>
      ...
      <div class="site-section bg-light" id="contact-section">
        ...
        <?php
        include 'dbcon.php';
        $stu=mysqli_query($conn,"select * from notification");
        while($a=mysqli_fetch_array($stu))
        {
            ...
            <tr>
                ...
                <!-- <td><a href="notidelete.php?id=<?php echo $a['id'];?>">Delete</a></td> -->
