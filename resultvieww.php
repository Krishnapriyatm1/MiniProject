...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="intro-section" id="home-section">
        ...
        <div class="slide-1" style="background-image: url('img12.jpg');" data-stellar-background-ratio="0.5">
          <div class="container">
      ...
      <div class="site-section bg-light" id="contact-section">
        ...
        <?php
        include 'dbcon.php';
        $stu=mysqli_query($conn,"select * from res_ult where uid='$val'");
        while($a=mysqli_fetch_array($stu))
        {
            ...
            <tr>
                ...
                <td style="color:green;font-size:20px;font-weight:bold;"> <?php echo $a['mark']; ?> </td>
